...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookPurchase", b =>
                {
                    ...
                    b.HasKey("BooksBookID", "PurchasesPurchaseID");
            ...
            modelBuilder.Entity("BookUser", b =>
                {
                    b.Property<int>("WishedById")
                        .HasColumnType("int");

                    b.Property<int>("WishlistBookID")
                        .HasColumnType("int");

                    b.HasKey("WishedById", "WishlistBookID");

                    b.HasIndex("WishlistBookID");
            ...
            modelBuilder.Entity("LibraryManagement.Models.Cart", b =>
                {
                    b.Property<int>("BookID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryManagement.Models.Purchase", b =>
                {
            ...
            modelBuilder.Entity("BookPurchase", b =>
                {
                    ...
                    b.HasOne("LibraryManagement.Models.Purchase", null)
                        .WithMany()
            ...
            modelBuilder.Entity("BookUser", b =>
                {
                    b.HasOne("LibraryManagement.Models.User", null)
                        .WithMany()
                        .HasForeignKey("WishedById")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LibraryManagement.Models.Book", null)
                        .WithMany()
                        .HasForeignKey("WishlistBookID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
